...
namespace App\Http\Controllers\Api\Transaksi\Reservasi\History;
...
class ReservasiHistoryController extends Controller
{
    public function daftarReservasiHistory(Request $request) {
        try {
            ...
            $sql = DB::table('reservasi')
                    ...
                    ->whereRaw("ifnull(reservasi.status_end, 0) = 1");
    ...
    public function detailReservasiHistory(Request $request) {
        try {
            $validate = Validator::make($request->all(), [
