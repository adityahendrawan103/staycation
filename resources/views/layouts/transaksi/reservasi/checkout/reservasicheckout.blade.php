...
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 pt-7">
        <h3 class="card-title align-rooms-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Daftar Reservasi (Check Out)</span>
                ...
                <table class="table table-bordered align-middle table-nowrap mb-0">
                    ...
                    <tbody class="border">
                        ...
                        <tr class="fs-6 fw-bold text-gray-700">
                            ...
                            <td class="ps-3 pe-3" style="text-align:center;vertical-align:top;">
                                <a href="{{ route('transaksi.reservasi.checkout.form-reservasi-checkout', trim($data->kode_reservasi)) }}" id="btnEdit" class="btn btn-icon btn-light-primary btn-sm mt-1" data-toggle="modal" data-kode={{ trim($data->kode_reservasi) }}>
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<div id="modalFilter" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div id="modalContentFilter" class="modal-content">
            <form id="formEntryFilter" name="formEntryFilter" autofill="off" autocomplete="off" method="get" action="{{ route('transaksi.reservasi.checkout.daftar-reservasi-checkout') }}">
