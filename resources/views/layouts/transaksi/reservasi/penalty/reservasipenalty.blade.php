...
@section('subtitle','Penalty')
@section('container')
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 pt-7">
        <h3 class="card-title align-rooms-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Daftar Reservasi (Penalty)</span>
                ...
                <table class="table table-bordered align-middle table-nowrap mb-0">
                    <thead class="border">
                        <tr class="fs-7 fw-bolder text-gray-500">
                            ...
                            <th class="w-100px ps-3 pe-3 text-center">Penalty</th>
                    ...
                    <tbody class="border">
                        ...
                        <tr class="fs-6 fw-bold text-gray-700">
                            ...
                            <td class="ps-3 pe-3" style="text-align:right;vertical-align:top;">
                                <span class="fs-7 fw-bolder text-gray-600">{{ trim($data->penalty) }}</span>
                            </td>
                            <td class="ps-3 pe-3" style="text-align:center;vertical-align:top;">
                                <a href="{{ route('transaksi.reservasi.penalty.form-reservasi-penalty', trim($data->kode_reservasi)) }}" id="btnEdit" class="btn btn-icon btn-light-primary btn-sm mt-1" data-toggle="modal" data-kode={{ trim($data->kode_reservasi) }}>
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <tr class="fw-bolder text-muted fs-6">
                            <td class="text-center p-20" colspan="9">- TIDAK ADA DATA YANG DITAMPILKAN -</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
