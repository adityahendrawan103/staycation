...
<div class="card mb-5 mb-xl-10">
    <div class="card-header border-0 pt-7">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder fs-3 mb-1">Daftar Jabatan</span>
            <span class="text-muted mt-1 fw-bold fs-7">Form jabatan karyawan</span>
        </h3>
        <div class="card-toolbar">
            <button id="btnTambah" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEntryJabatan">
    ...
    <div class="card-body p-9">
        <div class="fv-row mb-8">
            <label class="form-label">Cari Data Jabatan:</label>
            <div class="input-group">
                <span class="input-group-text">Pencarian</span>
                <input id="inputSearch" name="search" type="search" class="form-control" placeholder="Cari Data Jabatan"
        ...
        <div class="fv-row">
            <div class="table-responsive">
                <table class="table table-bordered align-middle table-nowrap mb-0">
                    ...
                    <tbody class="border">
                        @forelse($data_jabatan->data as $data)
                        <tr class="fs-6 fw-bold text-gray-700">
                            <td class="ps-3 pe-3">{{ trim($data->kode_jabatan) }}</td>
                            <td class="ps-3 pe-3">{{ trim($data->nama_jabatan) }}</td>
                            <td class="ps-3 pe-3">
                                <button id="btnEdit" class="btn btn-icon btn-light-primary btn-sm" data-toggle="modal" data-kode={{ trim($data->kode_jabatan) }}>
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <button id="btnHapus" class="btn btn-icon btn-light-danger btn-sm" data-kode={{ trim($data->kode_jabatan) }}>
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div class="row mt-4">
                ...
                <div class="col-sm-12 col-md-7 d-flex align-items-center justify-content-center justify-content-md-end">
                    <div class="dataTables_paginate paging_simple_numbers">
                        <ul class="pagination">
                            @foreach ($data_jabatan->links as $link)
...
<div id="modalEntryJabatan" class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div id="modalContentJabatan" class="modal-content">
            <form id="formEntryJabatan" name="formEntryJabatan" autofill="off" autocomplete="off" method="post" action="{{ route('master.karyawan.jabatan.simpan-jabatan') }}">
                @csrf
                <div class="modal-header">
                    <h3 id="modalTitleJabatan" class="modal-title"></h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="fv-row">
                        ...
                        <input id="inputKodeJabatan" name="kode_jabatan" type="text" class="form-control" placeholder="Input Kode Jabatan" maxlength="10" oninput="this.value = this.value.toUpperCase()" required>
                        <span id="messageKodeJabatan" class="invalid-feedback"></span>
                    </div>
                    <div class="fv-row mt-8">
                        <label class="form-label required">Keterangan:</label>
                        <input id="inputNamaJabatan" name="nama_jabatan" type="text" class="form-control" placeholder="Input Keterangan" maxlength="50" required>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    const url = {
        'data_jabatan': "{{ route('master.karyawan.jabatan.daftar-jabatan') }}",
        'form_jabatan': "{{ route('master.karyawan.jabatan.form-jabatan') }}",
        'hapus_jabatan': "{{ route('master.karyawan.jabatan.hapus-jabatan') }}",
        'cek_kode_jabatan': "{{ route('master.karyawan.jabatan.cek-kode-jabatan') }}"
    }
</script>
<script src="{{ asset('assets/js/app/master/karyawan/jabatan/jabatan.js') }}?v={{ time() }}"></script>
@endpush
@endsection
