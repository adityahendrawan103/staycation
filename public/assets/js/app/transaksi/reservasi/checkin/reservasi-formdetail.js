function hitungGrandTotal() {
    ...
    if ($('#inputStatusLongtime').is(':checked')) {
        ...
        xHargaRoom = $('#inputHargaLongtime').val().replaceAll(',', '');
        xLamaHari = Math.round(Math.abs((checkInDate - checkOutDate) / oneDay));
    } else {
        ...
        xHargaRoom = $('#inputHargaShorttime').val().replaceAll(',', '');
        xLamaHari = Math.ceil(hours / data.default_jam_reservasi);
    }

    // ========================================================================
    // Data Room
    // ========================================================================
    var input_room_disc_prosen = $('#inputDiskonRoomProsentase').val().replaceAll(',', '');
    var input_room_ppn_prosen = $('#inputPPNRoomProsentase').val().replaceAll(',', '');

    var harga_room = parseFloat(xHargaRoom) * parseFloat(xLamaHari);
    var harga_room_disc = (parseFloat(harga_room) * parseFloat(input_room_disc_prosen)) / 100;
    var harga_room_min_disc = parseFloat(harga_room) - parseFloat(harga_room_disc);
    var harga_room_ppn = (parseFloat(harga_room_min_disc) * parseFloat(input_room_ppn_prosen)) / 100;
    var harga_room_total = parseFloat(harga_room_min_disc) + parseFloat(harga_room_ppn);

    $('#inputHargaRoom').val(formatDecimal(harga_room));
    $('#inputDiscRoomNominal').val(formatDecimal(harga_room_disc));
    $('#inputPPNRoomNominal').val(formatDecimal(harga_room_ppn));
    $('#inputGrandTotalRoom').val(formatDecimal(harga_room_total));
